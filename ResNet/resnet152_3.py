...
ap.add_argument("-p", "--plot", type=str, default="resnet152_plot.png",
	help="path to output loss/accuracy plot")
ap.add_argument("-m", "--model", type=str,
	default="resnet152.model",
...
for imagePath in imagePaths:
  ...
  label = imagePath.split(os.path.sep)[-2]
	# load the input image (112x112) and preprocess it
...
feature_extractor_layer = ResNet152V2(weights="imagenet", include_top=False,
