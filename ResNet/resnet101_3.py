...
ap.add_argument("-p", "--plot", type=str, default="resnet101_plot.png",
	help="path to output loss/accuracy plot")
ap.add_argument("-m", "--model", type=str,
	default="resnet101.model",
...
feature_extractor_layer = ResNet101V2(weights="imagenet", include_top=False,
